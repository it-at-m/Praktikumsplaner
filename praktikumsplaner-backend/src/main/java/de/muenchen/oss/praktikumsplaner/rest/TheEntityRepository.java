...
import de.muenchen.oss.praktikumsplaner.domain.TheEntity;
...
@PreAuthorize("hasAuthority(T(de.muenchen.oss.praktikumsplaner.security.AuthoritiesEnum).PRAKTIKUMSPLANER_BACKEND_READ_THEENTITY.name())")
public interface TheEntityRepository extends CrudRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.oss.praktikumsplaner.security.AuthoritiesEnum).PRAKTIKUMSPLANER_BACKEND_WRITE_THEENTITY.name())")
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.oss.praktikumsplaner.security.AuthoritiesEnum).PRAKTIKUMSPLANER_BACKEND_DELETE_THEENTITY.name())")
