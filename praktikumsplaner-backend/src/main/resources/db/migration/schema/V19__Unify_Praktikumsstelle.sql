...
select s.id,
       ...
       coalesce(s.erwFuehrungszeugnisVorhanden, false),
       s.email,
       s.taetigkeiten,
       s.dringlichkeit,
       ...
       s.meldezeitraumID,
       s.assignedNwk,
       coalesce(s.planstelleVorhanden, false),
       s.wuensche,
...
select a.id,
       ...
       coalesce(a.erwFuehrungszeugnisVorhanden, false),
       a.email,
       a.taetigkeiten,
       a.dringlichkeit,
       ...
       a.meldezeitraumID,
       a.assignedNwk,
       coalesce(a.planstelleVorhanden, false),
       a.wuensche,
