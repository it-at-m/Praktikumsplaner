...
values
    -- aktueller Zeitraum
    ( '00000000-0000-0000-0000-000000000001', 'ITM-KM822', 'Wade Douglas', 'wade.douglas@localhost.de',
    ...
    ( '00000000-0000-0000-0000-000000000002', 'ITM-KM822', 'Wade Douglas', 'wade.douglas@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER1,SEMESTER2,SEMESTER3,SEMESTER4', 'BWI', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000003', 'ITM-KM822', 'Wade Douglas', 'wade.douglas@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER1,SEMESTER2,SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000004', 'ITM-KM822', 'Bobbie Valdez', 'Bobbie.valdez@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'LLB', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000005', 'ITM-KM822', 'Sonia Guerrero', 'sonia.guerrero@localhost.de',
      'diverse Aufgaben', 'DRINGEND', null, 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'PUMA', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000006', 'ITM-KM822', 'Alberto Burton', 'alberto.burton@localhost.de',
      'diverse Aufgaben', 'DRINGEND', null, 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'QE3', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000007', 'ITM-KM12', 'Brett Hoffman', 'brett.hoffman@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER1,SEMESTER2,SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000008', 'ITM-KM12', 'Cecil Bradley', 'cecil.bradley@localhost.de',
      'Projekt', 'ZWINGEND', 'Arthur Edwards', 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000009', 'ITM-KM23', 'Eileen Andrews', 'eileen.andrews@localhost.de',
      'Projekt', 'ZWINGEND', 'Francisco Olson', 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000001', null),

    ( '00000000-0000-0000-0000-000000000010', 'ITM-KM24', 'Alma Burton', 'alma.castro@localhost.de',
      'Projektunterstützung', 'DRINGEND', 'Janet Roberts', 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000001', null),

    -- previous zeitraum
    ( '00000000-0000-0000-0001-000000000001', 'ITM-KM822', 'Wade Douglas', 'wade.douglas@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER1,SEMESTER2,SEMESTER3,SEMESTER4', 'VI', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000002', 'ITM-KM822', 'Wade Douglas', 'wade.douglas@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER1,SEMESTER2,SEMESTER3,SEMESTER4', 'BWI', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000003', 'ITM-KM822', 'Wade Douglas', 'wade.douglas@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER1,SEMESTER2,SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000004', 'ITM-KM822', 'Bobbie Valdez', 'Bobbie.valdez@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'LLB', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000005', 'ITM-KM822', 'Sonia Guerrero', 'sonia.guerrero@localhost.de',
      'diverse Aufgaben', 'DRINGEND', null, 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'PUMA', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000006', 'ITM-KM822', 'Alberto Burton', 'alberto.burton@localhost.de',
      'diverse Aufgaben', 'DRINGEND', null, 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'QE3', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000007', 'ITM-KM12', 'Brett Hoffman', 'brett.hoffman@localhost.de',
      'diverse Aufgaben', 'NACHRANGIG', null, 'ITM', 'ja',
      'SEMESTER1,SEMESTER2,SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000008', 'ITM-KM12', 'Cecil Bradley', 'cecil.bradley@localhost.de',
      'Projekt', 'ZWINGEND', 'Marcus Harrison', 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000009', 'ITM-KM23', 'Eileen Andrews', 'eileen.andrews@localhost.de',
      'Projekt', 'ZWINGEND', 'Russell Long', 'ITM', 'ja',
      'SEMESTER3,SEMESTER4', 'BSC', '00000000-0000-0000-0000-000000000005', null),

    ( '00000000-0000-0000-0001-000000000010', 'ITM-KM24', 'Alma Burton', 'alma.castro@localhost.de',
...
values
    -- current zeitraum
    ( '00000000-0000-0000-0000-000000000011', 'ITM-KM31', 'Shannon Chavez', 'shannon.chavez@localhost.de',
      'Projekt', 'ZWINGEND', 'Crystal Jordan', 'ITM', true,
      'JAHR3', 'FISI', '00000000-0000-0000-0000-000000000001', null, 'true'),

    ( '00000000-0000-0000-0000-000000000012', 'ITM-KM31', 'Charles Gibson', 'charles.gibson@localhost.de',
      'Projektunterstützung', 'DRINGEND', 'Diana Barnes', 'ITM', false,
      'JAHR2', 'QE2', '00000000-0000-0000-0000-000000000001', null, 'true'),

    ( '00000000-0000-0000-0000-000000000013', 'ITM-KM32', 'Robert Smith', 'robert.smith@localhost.de',
      'Projektunterstützung', 'DRINGEND', null, 'ITM', true,
      'JAHR2,JAHR3', 'KFB', '00000000-0000-0000-0000-000000000001', null, 'false'),

    ( '00000000-0000-0000-0000-000000000014', 'ITM-KM22', 'Hans Smith', 'Hans.smith@localhost.de',
      'Projektunterstützung', 'DRINGEND', null, 'ITM', true,
      'JAHR2,JAHR3', 'VFAK', '00000000-0000-0000-0000-000000000001', null, 'false'),

    -- previous zeitraum
    ( '00000000-0000-0000-0001-000000000011', 'ITM-KM31', 'Shannon Chavez', 'shannon.chavez@localhost.de',
      'Projekt', 'ZWINGEND', 'Crystal Jordan', 'ITM', true,
      'JAHR3', 'FISI', '00000000-0000-0000-0000-000000000005', null, 'true'),

    ( '00000000-0000-0000-0001-000000000012', 'ITM-KM31', 'Charles Gibson', 'charles.gibson@localhost.de',
      'Projektunterstützung', 'DRINGEND', 'Lillian Henderson', 'ITM', false,
      'JAHR2', 'QE2', '00000000-0000-0000-0000-000000000005', null, 'true'),

    ( '00000000-0000-0000-0001-000000000013', 'ITM-KM32', 'Robert Smith', 'robert.smith@localhost.de',
      'Projektunterstützung', 'DRINGEND', null, 'ITM', true,
      'JAHR2,JAHR3', 'KFB', '00000000-0000-0000-0000-000000000005', null, 'false'),

    ( '00000000-0000-0000-0001-000000000014', 'ITM-KM22', 'Hans Smith', 'hans.smith@localhost.de',
      'Projektunterstützung', 'DRINGEND', null, 'ITM', true,
