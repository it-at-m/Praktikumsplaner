...
import de.muenchen.oss.praktikumsplaner.ApiGatewayApplication;
...
class GlobalRequestParameterPollutionFilterTest {
    ...
    void parameterPollutionAttack() {
        ...
        webTestClient.get().uri("/api/aa-a-backend-service/testendpoint?parameter1=testdata_1&parameter2=testdata&parameter1=testdata_2").exchange()
                .expectStatus()
