...
const meldezeitraum = ref<Meldezeitraum>(
    new Meldezeitraum("", new Date().toString(), new Date().toString())
);
...
const endZeitpunktRules = [
    ...
    validationRules.notEmptyRule("Es muss ein Endzeitpunkt angegeben werden"),
];
