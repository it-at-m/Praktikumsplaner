                        ...
                        <v-row>
                            ...
                            <v-col cols="2">
                                <v-tooltip right>
                                    ...
                                    <span
                                        ...
                                        priorisiert der Praktikumsplatz zu
                                        besetzen ist.</span
                                    >
                                </v-tooltip>
                            </v-col>
                            ...
                            <v-col cols="1">
                                <v-tooltip right>
                                    ...
                                    <span
                                        >Bei Anforderung einer bestimmten NWK
                                        für die Stelle, hier den vollständigen
                                        Namen eintragen.</span
                                    >
                                </v-tooltip>
                            </v-col>
                        </v-row>
                    ...
                    <v-container class="box">
                        ...
                        <v-row>
                            <v-col>
                                <v-select
                                    v-model="
                                        praktikumsstelle.programmierkenntnisse
                                    "
                    ...
                    <v-container class="box">
                        ...
                        <v-row>
                            <v-col>
                                <v-text-field
                                    v-model="
                                        praktikumsstelle.oertlicheAusbilder
                                    "
...
import SelectMultipleStudiensemester from "@/components/praktikumsstellen/Meldung/StudiensemesterSelect.vue";
